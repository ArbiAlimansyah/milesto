      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class='alert alert-danger'>
            <center>Silahkan Transfer Tagihan untuk transaksi pembelian anda ke no rekening dibawah ini dan selanjutnya lakukan konfirmasi pembayaran. Terima kasih,.. </center>
          </div>
          <hr style='margin:3px'>
